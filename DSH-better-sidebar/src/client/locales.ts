...
export const zh = {
  ...
  pluginMcpDesc: 'Model Context Protocol (MCP) 多源服务管理、工具洞察与在线调试沙箱',
}
...
export const en: Record<keyof typeof zh, string> = {
  ...
  pluginMcpDesc: 'Model Context Protocol (MCP) multi-source server manager and interactive tool debugging sandbox',
}
